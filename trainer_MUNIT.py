...
"""
from networks_MUNIT import AdaINGen, MsImageDis, VAEGen
from utils_MUNIT import weights_init, get_model_list, vgg_preprocess, load_vgg16, get_scheduler
...
class MUNIT_Trainer(nn.Module):
    def __init__(self, hyperparameters, opts):
        ...
        self.opt = opts
        self.device = torch.device('cuda:{}'.format(opts.gpu_ids[0])) if opts.gpu_ids else torch.device(
